...
class ControllerAffiliateLogin extends Controller {
	...
	public function index() {
		...
		$data['text_description'] = sprintf($this->language->get('text_description'), $this->config->get('config_name'.$this->config->get('config_language_id')), $this->config->get('config_name'.$this->config->get('config_language_id')), $this->config->get('config_affiliate_commission') . '%');
