...
class ControllerExtensionPaymentLiqPay extends Controller {
	public function index() {
		...
		$xml .= '	<description>' . $this->config->get('config_name'.$this->config->get('config_language_id')) . ' ' . $order_info['payment_firstname'] . ' ' . $order_info['payment_address_1'] . ' ' . $order_info['payment_address_2'] . ' ' . $order_info['payment_city'] . ' ' . $order_info['email'] . '</description>';
