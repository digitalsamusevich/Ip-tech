...
class ControllerExtensionPaymentPaypoint extends Controller {
	...
	public function callback() {
		...
		if ($order_info) {
			...
			$data['title'] = sprintf($this->language->get('heading_title'), $this->config->get('config_name'.$this->config->get('config_language_id')));
			...
			$data['heading_title'] = sprintf($this->language->get('heading_title'), $this->config->get('config_name'.$this->config->get('config_language_id')));
